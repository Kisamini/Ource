...
<p style="color:red;font-size:2em;">Error : ${error}</p>
  ...
  <script src="script/user_nav.js"></script>
    ...
    <link rel="stylesheet" type="text/css" href="css_main/top_navigation_bar.css">
        ...
        <div class="top_nav">
            <div class="go_home">
              <a href="index.html">
              	<img src="Image/ource_logo3_resized.png" alt="홈으로.." draggable="false" id="logoHome"/>
              </a>
            </div> 
              ...
              <c:forEach items="${profile.rows}" var="my">
                ...
                <a id="dropDownHref2" href="#"><img src="Image/user.png" draggable="false">${my.username} 님 환영합니다.</a>
                </c:if> 
