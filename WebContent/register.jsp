...
<html>
	...
	<link rel="stylesheet" href="css_register/registerPageStyle.css">
				...
				$.ajax({
					...
					success: function(checkResult) {
						...
						if(checkResult == 1){
							...
							$('#checkBody').html('아이디에는 한글 혹은 영문 대문자, 특수문자를 포함 시킬 수 없습니다.');
							$('#checkType').attr('class', 'modal-content panel-warning');
						}//else if
	...
	<title>아워스 회원가입 페이지</title>
		...
		<div class="container">
			...
			<table style="text-align: center;" id="registerTable">
			<thead>
				<tr>
					<th colspan="3" style="text-align: center;"> 
						<img src="./Image/ource_logo3.png" /> 
					</th>
				</tr> 
			</thead>
...
<!-- 아이디 중복 검사 버튼 ----------------------------------------------------------------------------------------------------------------------------------- -->
				...
				<tr> 
					...
					<td colspan="2">
						<input class="form-control" type="text" id="userQuest" maxLength="40" placeholder="본인만의 질문을 써 주세요.">
					</td>
				</tr>
				...
				<tr> 
					...
					<td colspan="2">
						<input class="form-control" type="text" id="userAnswer" maxLength="20" placeholder="질문의 답을 써 주세요.">
					</td>
				</tr>
				<tr>
					<td colspan="3">
