        ...
        <div class="user_friends">
          ...
          <ul>
          	...
          	<c:if test="${friends['profile_img'] eq '0'}" >
            	<li><a href="mypage.do?id=${friends.user_id}"><img id="user_friends_img" src="images/default_user_profile_img.png" alt="친구 이미지" draggable="false">${friends.user_name}</a></li>
            </c:if>
            <c:if test="${friends['profile_img'] ne '0'}" >
            	<li><a href="mypage.do?id=${friends.user_id}"><img id="user_friends_img" draggable="false" src="<c:url value='upload/${id}/${friends.profile_img}'/>" alt="친구 이미지">${friends.user_name}</a></li>
            </c:if>
            </c:forEach>
          </ul>
          </div>
