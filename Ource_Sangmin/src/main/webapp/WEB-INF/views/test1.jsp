        ...
        <div id="header">
        	<div class="user_profile"><br><br><br>
              ...
              <c:if test="${param.id eq sessionScope.sessionId }">
  				<button title="테스트 페이지" id="#" name="user_profile_update" class="replace">테스트 페이지</button>
				</c:if>
...
<div style="margin-top:500px;">테스트구간<br>
<c:forEach items="${mypageFollowing}" var="isFollowing">
<c:if test=" ${mypageFollowingCount != 0}">
	${isFollowing.profileImg}<br>
	</c:if>
</c:forEach>
</div>
