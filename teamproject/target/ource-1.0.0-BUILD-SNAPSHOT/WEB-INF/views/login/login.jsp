...
<html>
	...
	$(function(){
		$("#btnLogin").bind("click", function(){
			$(".loginform").attr("action", "loginSuccess.do");
		});
		
		$("#btnSearch").bind("click", function(){
			$(".loginform").attr("action", "search.do");
		}); 
	});
   </script>
	</head>
		...
		<div class="container">
			...
			<tbody>
				...
				<tr>
					...
					<td colspan="2"  align="left"><input class="form-control" type="password" name="passwd" maxLength="20" placeholder="비밀번호를 입력하세요." /></td></tr>
