		...
		$.ajax({
			...
			success : function(data){
				if(data.memberVO == null){
					...
					$("#userquest").val(data.memberVO.quest);
...
<div class="modal fade" id="myModal" role="dialog">
   ...
   <div class="logo_div"><img src="./images/logo_small.png"/></div> 
		...
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post">
				...
				<div class="wrap-input100 validate-input" data-validate = "Please enter your email: e@a.x">
					<input class="input100" type="text" name="birth" placeholder="생년월일을 입력하세요(EX : 19900607)">
					<span class="focus-input100"></span>
				</div>
			...
			<!--비밀번호 찾기  -->
                ...
                <div id="idCheckTest" align="left"> 다음 힌트에 대한 답을 적으세요.</div>
